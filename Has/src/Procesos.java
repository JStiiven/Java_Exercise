...
public class Procesos {
	...
	private void consultarEstudiantePorNombre() {
		if (!estudiante.isEmpty()) {
			String nombreEstu=JOptionPane.showInputDialog("Ingrese el nombre de estudiante a consultar.");
			for (Map.Entry<String, Integer> entry : estudiante.entrySet()) {
				if (entry.getKey().contains(nombreEstu)) {
					JOptionPane.showMessageDialog(null, "El estudiante "+ entry.getKey()+" con "+entry.getValue()+
							" años se encuentra en la lista!");
				} else {
					JOptionPane.showMessageDialog(null, "El estudiante no se encuentra en la lista!");
				}
			}
		} else {
			JOptionPane.showMessageDialog(null, "Error no hay estudiantes ingresados!!");
		}
	}
	...
	private void promedioEdades() {
		if (!estudiante.isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "Promedio de edades: "+prom);
		} else {
	...
	private void sumaEdades() {
		if (!estudiante.isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "La suma de edades: "+sumEdades);			
		} else {
	...
	private void ingresarEstudiantes() {
		String nombre=JOptionPane.showInputDialog("Ingresar nombre estudiante");
